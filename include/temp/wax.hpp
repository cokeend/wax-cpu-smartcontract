   ...
   public:
      using contract::contract;
       wax( name receiver, name code, datastream<const char*> ds )
         : contract(receiver, code, ds), stakingtab(receiver,receiver.value),configtab(receiver,receiver.value),crontab(receiver,receiver.value),packagetab(receiver,receiver.value), wax_symbol("WAX",8) {}
