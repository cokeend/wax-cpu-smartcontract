...
class [[eosio::contract("wax")]] wax : public contract {
  ...
  // auto stake_cpu_qty2 = asset(0,wax_symbol);
   auto price_7d = asset(300000000,wax_symbol);
   auto price_15d = asset(600000000,wax_symbol);
   auto price_30d = asset(1000000000,wax_symbol);
